...
- Użytkownik może logować się do systemu poprzez przycisk "Zaloguj" w nawigacji w głównym @Layout.astro.
- Użytkownik może się wylogować z systemu poprzez przycisk "Wyloguj" w nawigacji w głównym @Layout.astro.
