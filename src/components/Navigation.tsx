            ...
            <div className="px-2 pt-2 pb-3 space-y-1 max-h-[calc(100vh-80px)] overflow-y-auto">
              ...
              <div className="border-t border-gray-200 pt-4 mt-4">
                <div className="px-3 py-2">
                  <div className="text-sm text-gray-600 mb-2">placeholder@email.com</div>
                  <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-md text-sm font-medium transition-colors w-full text-left">
                    Wyloguj
                  </button>
                </div>
              </div>
          ...
          >
            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:flex md:items-center md:space-x-4">
                <span className="text-sm text-gray-600">placeholder@email.com</span>
